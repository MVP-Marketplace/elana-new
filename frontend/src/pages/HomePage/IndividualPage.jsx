  ...
  return (
    <div className="">
      ...
      <div className="homepage-banner-9">
        <h1 className="banner-2-h1 pt-5 px-1 text-center fs-40-24">
          Health providers on Elana include:
        </h1>
        <div className="py-5">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al ">
                      <span className="fs-24 text-dark ">Yoga Instructors</span>
                    </MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </div>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-2">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al">
                      <span className="fs-24 text-dark">Pilates Instructors</span>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-3">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al">
                      <span className="fs-24 text-dark">Physical Therapy</span>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-4">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al">
                      <span className="fs-24 text-dark">Pain Management</span>
                    </MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </div>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-1">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al ">
                      <span className="fs-24 text-dark ">Health Coach</span>
                    </MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </div>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-2">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al">
                      <span className="fs-24 text-dark">Gynecologist</span>
            ...
            <MDBCol md="3">
              <div className="d-flex banner-2-circle-1">
                ...
                >
                  <MDBCardBody className="d-flex align-items-center justify-content-center">
                    <MDBCardText className="text-center text-al ">
                      <span className="fs-24 text-dark ">And more</span>
                    </MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </div>
        ...
        <h3 className="pt-4 pb-5 text-center fs-24 text-al hidden">
